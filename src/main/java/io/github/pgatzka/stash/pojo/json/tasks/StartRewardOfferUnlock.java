...
public record StartRewardOfferUnlock(
        @JsonProperty(value = "attributes", required = true) @JsonSetter(nulls = Nulls.FAIL) @NonNull Object @NonNull [] attributes,
        @JsonProperty(value = "contains", required = true) @JsonSetter(nulls = Nulls.FAIL) @NonNull OfferUnlockContain2 @NonNull [] contains,
